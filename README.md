...
نظرة عامة:
ثيم رائد هو نقطة البداية للمطورين لتصميم ثيمات لمتاجر التجزئة تعكس تفرد كل متجر على منصة سلة. ستجعل الثيمات المخصصة من السهل على المطورين تخصيص متجر التجزئة ليتناسب مع متطلباته المتغيرة بمرور الوقت. تم شحنه كالثيم الافتراضي مع ثيمات تويللايت، وهو محرك ثيمات سلة للمطورين لإنشاء ثيمات قابلة للتخصيص لاستخدامها على منصة سلة.
البدء:
يمكن للمطورين استخدام ثيم سلة رائد ليس فقط لتصميم ثيمات سلة باستخدام ملفات HTML/CSS/JS مخصصة ومكونات واجهة مستخدم قابلة لإعادة الاستخدام، ولكن أيضًا لبناء إجراءات مخصصة تؤدي إلى أحداث JS وhooks.
المتطلبات الأساسية:
فهم أساسي لـ HTML وCSS وJS ومحرك القوالب Twig.
حساب شريك في بوابة شراكة سلة لإنشاء متجر تجريبي لنشر واختبار الثيم الخاص بك.
حساب Github يمكن مزامنة الثيم فيه.
تثبيت Salla CLI.
4. التثبيت:
يتم تثبيت ثيم رائد بشكل افتراضي عند تثبيت ثيمات تويللايت. يمكن تثبيت تويللايت بطريقتين: من خلال بوابة شراكة سلة أو من خلال Salla CLI. في كلتا الحالتين، سيؤدي ذلك إلى تثبيت محرك تويللايت وثيم رائد.
الاستخدام:
سيتم تثبيت ثيم رائد كالثيم الافتراضي عند تثبيت تويللايت. سننظر في كيفية إعداد أدلة هذا الثيم وكيفية استخدام وضع المعاينة في القسم التالي.
6. هيكل الدليل:
ثيم رائد هو مجموعة من الملفات والمجلدات التي تحدد طبقة عرض متجر سلة.
7. معاينة الثيم:
باستخدام Salla CLI، يمكن للمطور معاينة الثيم أثناء تطويره. تساعد أمر preview المطور في رؤية الثيم في وضع مباشر. لتشغيل أمر المعاينة، يجب أن يكون المطور في مجلد الثيم الجذر.
الميزات الرئيسية:
بشكل افتراضي، تعرض الصفحة الرئيسية لثيم رائد مجموعة من المكونات المعرفة مسبقًا والمخصصة. تقع هذه المكونات في مجلد src/views/components/home/.
9. ميزات الثيم:
المكونات المعرفة مسبقًا، المعروفة باسم ميزات الثيم، مدرجة في twilight.json تحت قسم features.
مكونات الثيم:
يمكن تعديل المكونات المخصصة بسهولة من قبل المطور. تُعرف هذه المكونات بمكونات الثيم.
11. الدعم:
فريقنا دائمًا هنا لمساعدتك. هل تواجه مشكلة؟ هل تريد الإبلاغ عن خطأ؟ يمكنك تقديم واحدة هنا على Github باستخدام متعقب المشكلات. إذا كان لديك أي أسئلة أخرى، يرجى الاتصال بنا عبر روبوت تيليجرام أو الانضمام إلى مجتمع المطورين العالمي على تيليجرام.
12. المساهمة:
المساهمات هي ما يجعل مجتمع المصدر المفتوح مكانًا رائعًا للتعلم والإلهام والإبداع. أي مساهمات تقوم بها هي مقدرة للغاية. إذا كان لديك اقتراح يمكن أن يجعل هذا أفضل، يرجى عمل فورك للمستودع وإنشاء طلب سحب.
13. الشكر:
سلة وجميع المساهمين.
الرخصة:
رخصة MIT (MIT). يرجى الاطلاع على ملف الرخصة لمزيد من المعلومات.